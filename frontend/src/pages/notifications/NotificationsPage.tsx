...
export interface NotificationsPageProps { onOpenPost?: (postId: string) => void; onUnreadCountChange?: (count: number) => void; }
...
export function NotificationsPage({ onOpenPost, onUnreadCountChange }: NotificationsPageProps) { const [notifications, setNotifications] = useState<ActivityNotification[]>([]); const [loading, setLoading] = useState(true); const [error, setError] = useState(""); const [markingId, setMarkingId] = useState(""); const [markingAll, setMarkingAll] = useState(false); const [reloadNumber, setReloadNumber] = useState(0);
