...
export interface ExplorePerson { id: string; name?: string; email?: string; user_type?: string; role?: string; specialty?: string; hospital?: string; avatar_url?: string; is_verified?: boolean; is_following?: boolean; }
